...
# define TERMUX_PREFIX "/data/data/Ninja.coder.Ghostemane.code/files/usr"
#endif

#ifndef TERMUX_X11_DIR
# define TERMUX_X11_DIR "/data/data/Ninja.coder.Ghostemane.code.x11/"
#endif
...
int main(int argc, char *argv[]) {
	...
	char *server_argv[] = {TERMUX_PREFIX "/bin/am", "start", "-n", "Ninja.coder.Ghostemane.code.x11/.MainActivity", NULL};
