...
TERMUX_APP_PACKAGE="Ninja.coder.Ghostemane.code"
...
# Path to CGCT tools
CGCT_DEFAULT_PREFIX="/data/data/Ninja.coder.Ghostemane.code/files/usr/glibc"
export CGCT_DIR="/data/data/Ninja.coder.Ghostemane.code/cgct"
...
TERMUX_REPO_PACKAGE="Ninja.coder.Ghostemane.code"
